...
dataframe_control = pd.read_excel(r"C:\Users\WIN\OneDrive\Masaüstü\DSMLBC\dsmlbc8\dsmlbc8-datasets\ab_testing.xlsx" , sheet_name="Control Group")
dataframe_test = pd.read_excel(r"C:\Users\WIN\OneDrive\Masaüstü\DSMLBC\dsmlbc8\dsmlbc8-datasets\ab_testing.xlsx" , sheet_name="Test Group")
...
df = df[[i for i in df_control.columns if "Unnamed" not in i]]
df.head()
